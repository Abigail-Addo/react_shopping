  ...
  useEffect(() => {
    ...
    const totalPrices = () => {
      const numberFormat = parseFloat(
        pricesCal().replace("GH\u00A2 ", "").replace(",", "")
      );
      const prices = numberFormat + 20;
      const formattedTotalPrice = prices
        .toFixed(2)
        .replace(/\d(?=(\d{3})+\.)/g, "$&,");
    ...
    (async function () {
      try {
        const result = await fetch(
          "https://shopping-backend-mhxl.onrender.com/api/v1/config"
        );
    ...
    (async function () {
      ...
      try {
        const result = await fetch(
          "https://shopping-backend-mhxl.onrender.com/api/v1/create-payment-intent",
          {
            method: "POST",
            body: JSON.stringify({
            ...
            <div className="col-md-5 col-lg-4 order-md-last">
              ...
              <ul className="list-group mb-3">
                <li className="list-group-item d-flex justify-content-between lh-sm">
                  ...
                  <span className="text-body-secondary itemTotal">
                    {pricesCal()}
                  </span>
                </li>
                <li className="list-group-item d-flex justify-content-between lh-sm">
                  ...
                  <span className="text-body-secondary delivery">
                    GH&cent; 20
                  </span>
                </li>
